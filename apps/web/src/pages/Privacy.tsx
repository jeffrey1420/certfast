  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="alternate" hrefLang="fr" href="https://certfast.io/privacy?lang=fr" />
        <link rel="alternate" hrefLang="en" href="https://certfast.io/privacy?lang=en" />
      </Helmet>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <header className="bg-white border-b border-gray-200">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
            ...
            <p className="text-gray-600">{t('legal.lastUpdated', { date: t('privacy.date') })}</p>
          </div>
        </header>
